package eu.luminess.indus.avec_thread.concurent.basic;

import eu.luminess.indus.avec_thread.concurent.task.CallableComputing;
import eu.luminess.indus.avec_thread.concurent.task.LongTask;
